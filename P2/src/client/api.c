...
int kvs_disconnect() {
    ...
    // open pipe req_pipe_path to request disconnection
    int req_pipe_fd = open(req_pipe, O_WRONLY);
    ...
    int resp_pipe_fd = open(resp_pipe, O_RDONLY);
...
int kvs_subscribe(const char *key) {
    ...
    // open pipe req_pipe_path to request subscription
    int req_pipe_fd = open(req_pipe, O_WRONLY);
